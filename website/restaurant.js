...
var gTastyListInfo = [
  ...
  ['赤燒分子廚藝丼', '高雄市左營區富國路103號', '0988-589-199'],
  ['橘葉 壽司、丼飯專門店', '高雄市苓雅區林泉街65號', '07-722-1812'],
  ['大港參貳牛排館', '高雄市鹽埕區五福四路32號', '07-521-6200'],
  ['希ラーメン拉麵', '高雄市左營區蓮潭路121號', '07-581-6521'],
  ['Awake coffee', '高雄市前鎮區民豐街24號', '07-334-0285'],
  ['type:'+gListType[2], 'city:'+gCityInfo[1][0], 'length:7'],
  ...
  ['步道咖啡館 Cafe Strada', '高雄市新興區中正四路44號', '07-285-0055'],
  ['五零年代咖啡', '高雄市鹽埕區大智路99號', '0955-636-910'],
...
var gUnknownListInfo = [
  ...
  ['【麵屋祥】東京醬油拉麵', '高雄市鼓山區大順一路459號', NO_PHONE],
  ['丸叄食伍', '高雄市新興區中東街277號', '072355255'],
  ['一鍋鮮海鮮料理', '高雄市左營區文萊路246號', '07-345-5319'],
  ['小小麥', '高雄市苓雅區中山二路313號', '07-338-1410'],
  ['皮蔻莉', '高雄市三民區河堤路622號', '0979-309-910'],
  ['type:'+gListType[2], 'city:'+gCityInfo[1][0], 'length:14'],
  ['八德薏仁大王', '高雄市新興區八德一路167號', '07-238-8656'],
  ['猜心泡芙', '高雄市苓雅區泰順街60號', '0965-181-010'],
  ['朵莉甜廚 法式甜點專賣店', '高雄市苓雅區民權一路88號', '07-229-3666'],
  ['撒豆サトウ', '高雄市鳳山區文享街230號', '0931-197-585'],
  ['春田氷亭', '高雄市鼓山區臨海三路5號4樓', '07-531-2770'],
  ['喫茶·鳩谷', '高雄市苓雅區正義路3巷10號', '0958-419-680'],
  ['屋裏有甜點WULI', '高雄市新興區渤海街153號1樓', '07-222-8336'],
  ['新銳咖啡', '高雄市三民區鼎中路172號', '07-350-8520'],
  ['小島製冰', '高雄市苓雅區武廟路88巷3弄4-2號', NO_PHONE],
  ['COFFEE UP 瑞秋 • 咖啡', '高雄市左營區高鐵路96號', NO_PHONE],
  ['Around Cafe 流浪咖啡', '高雄市苓雅區福建街66號', '07-338-8529'],
  ['胖尼咖啡 Pane e Caffè', '高雄市左營區博愛二路204號', '07-550-6356'],
  ['禾苑蔗片冰', '高雄市鼓山區博愛二路347號', '07-586-7972'],
  ['靠杯咖啡 KAO CUP COFFEE', '高雄市鼓山區青海路187號', '07-522-6987'],
